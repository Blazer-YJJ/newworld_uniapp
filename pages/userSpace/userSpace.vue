<template>
	<view>
		<image src="https://s3.bmp.ovh/imgs/2022/06/23/0cd9efa193f613b4.jpg" 
			   mode="aspectFill"
		...
		<view class="border-bottom" style="height: 350rpx;">
			...
			<view class="px-4">
				<view class="text-ellipsis fpnt-sm text-light-muted"
		...
		>
			<swiper-item v-for="(tab, tabI) in tabBars" :key="tabI">
				...
				>
					...
					<media-list v-for="(item, index) in list[tabI].data" 
								:key="index"
								:item="item"
								:index="index"
					>
