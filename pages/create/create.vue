<template>
	<view>
		<view class="bg-light position-relative" 
		      style="height: 350rpx;"
			  hover-class="bg-hover-light"
			  @tap="upload"
		>
			<image v-if="form.cover"
			       :src="form.cover" 
			       mode="aspectFill"
		...
		<form-item title="发布标题">
			<input type="text" 
			       placeholder="请填写发布视频标题" 
				   placeholder-class="text-light-munted"
				   class="w-100 pr-5" 
				   v-model="form.title"
			/>
		</form-item>
		...
		<view class="py-2 px-3">
			<main-big-button>
				<text class="iconfont icon-guanzhu px-2"
					  @tap="submit"
				></text>
				发 布
			</main-big-button>
