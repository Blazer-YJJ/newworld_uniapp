<template>
	<view class="flex align-center position-relative" style="height: 44px;" @touchstart="touchstart"
		...
		<view class="position-absolute rounded-circle bg-main-hover" style="width: 15px;height: 15px;"
