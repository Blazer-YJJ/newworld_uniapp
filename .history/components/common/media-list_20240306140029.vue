<template>
	<view>
		<view class="flex flex-1 align-center py-1 border-bottom" style="100%" @click="open">
			<image :src="item.cover" class="rounded-lg mx-2 flex-shrink" style="width: 260rpx; height: 160rpx;">
			</image>
